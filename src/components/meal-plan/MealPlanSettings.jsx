...
export default function MealPlanSettings({
  ...
  return (
    <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-gray-700 mb-6 space-y-4">
      <h4 className="font-bold text-slate-800 dark:text-white flex items-center gap-2"><Settings size={18} className="text-slate-500 dark:text-slate-400" /> Ajustes de este Plan</h4>

      <div className="grid lg:grid-cols-3 gap-4">
        <div>
          <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">Tienes alguna preferencia hoy?</label>
          <input
            type="text"
            ...
            className="w-full p-3 rounded-xl border border-slate-200 dark:border-gray-600 focus:ring-2 focus:ring-green-500 outline-none bg-slate-50 dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 text-sm transition-all"
          />
        </div>
